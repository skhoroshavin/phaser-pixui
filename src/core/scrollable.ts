...
export class Scrollable extends Interactive {
  ...
  get scrollX() {
    return PMath.Clamp(this._scrollPosition.x - this._dragPosition.x, 0, this._maxScrollPosition.x);
  }
  ...
  get scrollY() {
    return PMath.Clamp(this._scrollPosition.y - this._dragPosition.y, 0, this._maxScrollPosition.y);
  }
